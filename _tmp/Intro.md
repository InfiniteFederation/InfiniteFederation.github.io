...
/ My flagship work has been architecting the firm's **first Cyber Data Mesh ecosystem**, That become the foundation of our cyber security.
/ — a Kubernetes-native 'SQL-on-anything' platform 
/ built on fedrated data lake technology (trino) and Iceberg. 
// platform has grown to support more than a **thousand users** 
/ and processing over **200,000 queries a day** 
/ achieving a **99.98% ** successful query completion rate.
